<?php
//Include Common Files @1-D0DA4C60
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "BoxPopup.php");
...
//Class_Initialize Event @2-5402EA19
...
"FROM tblcollect_design {SQL_Where} {SQL_OrderBy}";
            $this->s_DesignName->DataSource->Order = "DesignName";
...
"FROM tblcollect_name {SQL_Where} {SQL_OrderBy}";
            $this->s_NameDesc->DataSource->Order = "NameDesc";
...
"FROM tblcollect_category {SQL_Where} {SQL_OrderBy}";
            $this->s_CategoryName->DataSource->Order = "CategoryName";
...
"FROM tblcollect_size {SQL_Where} {SQL_OrderBy}";
            $this->s_SizeName->DataSource->Order = "SizeName";
...
"FROM tblcollect_texture {SQL_Where} {SQL_OrderBy}";
            $this->s_TextureName->DataSource->Order = "TextureName";
...
"FROM tblcollect_color {SQL_Where} {SQL_OrderBy}";
            $this->s_ColorName->DataSource->Order = "ColorName";
...
"FROM tblcollect_material {SQL_Where} {SQL_OrderBy}";
            $this->s_MaterialName->DataSource->Order = "MaterialName";
...
//Operation Method @2-E7979A38
    function Operation()
    {
        ...
        $Redirect = "BoxPopup.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "BoxPopup.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_DesignName", "s_NameDesc", "s_CategoryName", "s_SizeName", "s_TextureName", "s_ColorName", "s_MaterialName", "s_CollectCode", "ccsForm")));
...
class clsGridGrid { //Grid class @12-76129994

//Variables @12-7323EF57
...
//Class_Initialize Event @12-3AAF8171
...
} //End Grid Class @12-FCB6E20C

class clsGridDataSource extends clsDBgayafusionall {  //GridDataSource Class @12-7708C172

//DataSource Variables @12-97683C68
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @12-346952B2
...
//Prepare Method @12-C19DB172
    function Prepare()
    {
        ...
        $this->wp->Criterion[1] = $this->wp->Operation(opContains, "tblcollect_design.DesignCode", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opContains, "tblcollect_name.NameCode", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsText),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opContains, "tblcollect_category.CategoryCode", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsText),false);
        $this->wp->Criterion[4] = $this->wp->Operation(opContains, "tblcollect_size.SizeCode", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsText),false);
        ...
        $this->wp->Criterion[6] = $this->wp->Operation(opContains, "tblcollect_color.ColorCode", $this->wp->GetDBValue("6"), $this->ToSQL($this->wp->GetDBValue("6"), ccsText),false);
        $this->wp->Criterion[7] = $this->wp->Operation(opContains, "tblcollect_material.MaterialCode", $this->wp->GetDBValue("7"), $this->ToSQL($this->wp->GetDBValue("7"), ccsText),false);
...
//Open Method @12-9EC79143
    function Open()
    {
        ...
        "Photo1, RealSellingPrice, LastUpdate, ID \n\n" .
        "FROM ((((((tblcollect_master INNER JOIN tblcollect_name ON\n\n" .
        "tblcollect_master.NameCode = tblcollect_name.NameCode) INNER JOIN tblcollect_size ON\n\n" .
        "tblcollect_master.SizeCode = tblcollect_size.SizeCode) INNER JOIN tblcollect_category ON\n\n" .
        "tblcollect_master.CategoryCode = tblcollect_category.CategoryCode) INNER JOIN tblcollect_color ON\n\n" .
...
} //End GridDataSource Class @12-FCB6E20C

//Initialize Page @1-108CCD3A
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "BoxPopup.html";
$BlockToParse = "main";
...
//Include events file @1-8C49619B
include_once("./BoxPopup_events.php");
