    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->PL_H_ID->Parameters = CCAddParam($this->PL_H_ID->Parameters, "AddressID", $this->DataSource->f("AddressID"));
                $this->PL_H_ID->Parameters = CCAddParam($this->PL_H_ID->Parameters, "DeliveryAddressID", $this->DataSource->f("DeliveryAddressID"));
                ...
                $this->PLNo->Parameters = CCAddParam($this->PLNo->Parameters, "AddressID", $this->DataSource->f("AddressID"));
                $this->PLNo->Parameters = CCAddParam($this->PLNo->Parameters, "DeliveryAddressID", $this->DataSource->f("DeliveryAddressID"));
...
//Open Method @2-BF563CA3
    function Open()
    {
        ...
        "tbladminist_packinglist_h.Invoice_H_ID = tbladminist_invoice_h.Invoice_H_ID";
        ...
        "tbladminist_packinglist_h.DeliveryContactID AS DeliveryContactID, Company, InvoiceNo, tbladminist_packinglist_h.AddressID AS AddressID,\n\n" .
        "tbladminist_packinglist_h.DeliveryAddressID AS DeliveryAddressID \n\n" .
        "FROM (tbladminist_packinglist_h INNER JOIN tbladminist_addressbook ON\n\n" .
        "tbladminist_packinglist_h.AddressID = tbladminist_addressbook.AddressID) LEFT JOIN tbladminist_invoice_h ON\n\n" .
        "tbladminist_packinglist_h.Invoice_H_ID = tbladminist_invoice_h.Invoice_H_ID {SQL_Where} {SQL_OrderBy}";
...
//Class_Initialize Event @19-7E9B7AA3
...
"FROM tbladminist_addressbook {SQL_Where} {SQL_OrderBy}";
            list($this->s_AddressID->BoundColumn, $this->s_AddressID->TextColumn, $this->s_AddressID->DBFormat) = array("AddressID", "Company", "");
