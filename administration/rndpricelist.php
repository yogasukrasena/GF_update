<?php
//Include Common Files @1-0D865FE1
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "RnDPriceList.php");
...
//Operation Method @3-F98E66CB
    function Operation()
    {
        ...
        $Redirect = "RnDPriceList.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "RnDPriceList.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @2-7DF273E0
    function clsGridsampleceramicGrid($RelativePath, & $Parent)
    {
        ...
        $this->Link1 = new clsControl(ccsLink, "Link1", "Link1", ccsFloat, array(False, 2, Null, Null, False, "", "", 1, True, ""), CCGetRequestParam("Link1", ccsGet, NULL), $this);
        $this->Link1->Page = "EditRnDPrice.php";
        $this->lblDollar = new clsControl(ccsLabel, "lblDollar", "lblDollar", ccsFloat, array(False, 2, Null, Null, False, "", "", 1, True, ""), CCGetRequestParam("lblDollar", ccsGet, NULL), $this);
        $this->lblEuro = new clsControl(ccsLabel, "lblEuro", "lblEuro", ccsFloat, array(False, 2, Null, Null, False, "", "", 1, True, ""), CCGetRequestParam("lblEuro", ccsGet, NULL), $this);
        $this->LastUpdate = new clsControl(ccsLabel, "LastUpdate", "LastUpdate", ccsDate, array("dd", "/", "mm", "/", "yyyy"), CCGetRequestParam("LastUpdate", ccsGet, NULL), $this);
...
//Show Method @2-638C9DE3
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["lblDollar"] = $this->lblDollar->Visible;
            $this->ControlsVisible["lblEuro"] = $this->lblEuro->Visible;
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->Link1->Parameters = CCAddParam($this->Link1->Parameters, "ID", $this->DataSource->f("sID"));
                $this->lblDollar->SetValue($this->DataSource->lblDollar->GetValue());
                $this->lblEuro->SetValue($this->DataSource->lblEuro->GetValue());
...
//GetErrors Method @2-FD05CD93
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->lblDollar->Errors->ToString());
        $errors = ComposeStrings($errors, $this->lblEuro->Errors->ToString());
...
//DataSource Variables @2-1EB1C44D
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-63782AC6
    function clssampleceramicGridDataSource(& $Parent)
    {
        ...
        $this->Link1 = new clsField("Link1", ccsFloat, "");
        
        $this->lblDollar = new clsField("lblDollar", ccsFloat, "");
        
        $this->lblEuro = new clsField("lblEuro", ccsFloat, "");
...
//SetValues Method @2-CE773705
    function SetValues()
    {
        ...
        $this->Link1->SetDBValue(trim($this->f("RealSellingPrice")));
        $this->lblDollar->SetDBValue(trim($this->f("PriceEuro")));
        $this->lblEuro->SetDBValue(trim($this->f("PriceEuro")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "RnDPriceList.html";
$BlockToParse = "main";
...
//Include events file @1-3E5CCE10
include_once("./RnDPriceList_events.php");
