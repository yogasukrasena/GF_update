...
//Class_Initialize Event @40-5402EA19
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "PriceList.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_DesignName", "s_NameDesc", "s_CategoryName", "s_SizeName", "s_TextureName", "s_ColorName", "s_MaterialName", "s_CollectCode", "ccsForm")));
...
//Show Method @40-A26ABE3F
    function Show()
    {
        ...
        $this->Button_DoSearch->Attributes->SetValue("rowNumber", CCGetFromGet("rowNumber", NULL));
...
//Class_Initialize Event @2-DD306B07
...
//DataSource Variables @2-D50E6C4A
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-0D3539C6
