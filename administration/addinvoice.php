...
class clsRecordAddNewHeader { //AddNewHeader Class @142-5850F9DE

//Variables @142-9E315808
...
//Class_Initialize Event @142-1A2C145A
...
"FROM tbladminist_addressbook_contact {SQL_Where} {SQL_OrderBy}";
            ...
            $this->Attn->DataSource->Parameters["expr161"] = 0;
            $this->Attn->DataSource->wp = new clsSQLParameters();
            $this->Attn->DataSource->wp->AddParameter("1", "expr161", ccsInteger, "", "", $this->Attn->DataSource->Parameters["expr161"], "", false);
            ...
            $this->LinkChange->Page = "AddInvoice.php";
...
"FROM tbladminist_addressbook_contact {SQL_Where} {SQL_OrderBy}";
            ...
            $this->DeliveryContactID->DataSource->Parameters["expr173"] = 0;
            $this->DeliveryContactID->DataSource->wp = new clsSQLParameters();
            $this->DeliveryContactID->DataSource->wp->AddParameter("1", "expr173", ccsInteger, "", "", $this->DeliveryContactID->DataSource->Parameters["expr173"], "", false);
...
"FROM tbladminist_paymentterm {SQL_Where} {SQL_OrderBy}";
            ...
            $this->CurrencyID = new clsControl(ccsListBox, "CurrencyID", "CurrencyID", ccsInteger, "", CCGetRequestParam("CurrencyID", $Method, NULL), $this);
            $this->CurrencyID->DSType = dsTable;
            $this->CurrencyID->DataSource = new clsDBgayafusionall();
            $this->CurrencyID->ds = & $this->CurrencyID->DataSource;
            $this->CurrencyID->DataSource->SQL = "SELECT * \n" .
"FROM tbladminist_currency {SQL_Where} {SQL_OrderBy}";
            list($this->CurrencyID->BoundColumn, $this->CurrencyID->TextColumn, $this->CurrencyID->DBFormat) = array("CurrencyID", "Currency", "");
        }
    }
//End Class_Initialize Event

//Initialize Method @142-8B553631
    function Initialize()
    {
...
//Validate Method @142-FAADB963
    function Validate()
    {
        ...
        $this->DataSource->InvoiceNo->SetValue($this->InvoiceNo->GetValue());
        if(CCDLookUp("COUNT(*)", "tbladminist_invoice_h", "InvoiceNo=" . $this->DataSource->ToSQL($this->DataSource->InvoiceNo->GetDBValue(), $this->DataSource->InvoiceNo->DataType) . $Where, $this->DataSource) > 0)
            $this->InvoiceNo->Errors->addError($CCSLocales->GetText("CCS_UniqueValue", "Invoice No"));
...
//CheckErrors Method @142-BC77FB59
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_Insert") {
                ...
                $Redirect = "Invoice.php" . "?" . CCGetQueryString("QueryString", array("ccsForm", "Invoice_H_ID", "AddressID", "DeliveryAddressID", "InvoiceContactID", "DeliveryContactID"));
...
//InsertRow Method @142-A4FFB5C0
    function InsertRow()
    {
        ...
        $this->DataSource->CurrencyID->SetValue($this->CurrencyID->GetValue(true));
...
//Show Method @142-E4AA6EB2
    function Show()
    {
        ...
        $this->LinkChange->Parameters = CCGetQueryString("QueryString", array("InvoiceContactID", "AddressID", "ccsForm"));
        $this->LinkChange->Parameters = CCAddParam($this->LinkChange->Parameters, "Invoice_H_ID", $this->DataSource->f("Invoice_H_ID"));
        $this->LinkChange->Parameters = CCAddParam($this->LinkChange->Parameters, "DeliveryAddressID", $this->DataSource->f("DeliveryAddressID"));
        $this->LinkChange->Parameters = CCAddParam($this->LinkChange->Parameters, "DeliveryContactID", $this->DataSource->f("DeliveryContactID"));
        ...
        $this->LinkChangeDeliveryContact->Parameters = CCAddParam($this->LinkChangeDeliveryContact->Parameters, "InvoiceContactID", $this->DataSource->f("InvoiceContactID"));
...
} //End AddNewHeader Class @142-FCB6E20C

class clsAddNewHeaderDataSource extends clsDBgayafusionall {  //AddNewHeaderDataSource Class @142-B5B08D50

//DataSource Variables @142-DB6329D9
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @142-ED050D4C
    function clsAddNewHeaderDataSource(& $Parent)
    {
        ...
        $this->InsertFields["InvoiceDate"] = array("Name" => "InvoiceDate", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
        ...
        $this->InsertFields["GayaOrderRef"] = array("Name" => "GayaOrderRef", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        ...
        $this->InsertFields["DueDate"] = array("Name" => "DueDate", "Value" => "", "DataType" => ccsDate, "OmitIfEmpty" => 1);
        ...
        $this->UpdateFields["CurrencyID"] = array("Name" => "CurrencyID", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
    }
//End DataSourceClass_Initialize Event

//Prepare Method @142-165F7009
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//SetValues Method @142-9FA137AE
    function SetValues()
    {
        $this->InvoiceNo->SetDBValue($this->f("InvoiceNo"));
        $this->ProformaDate->SetDBValue(trim($this->f("InvoiceDate")));
        ...
        $this->PreviewDPDate->SetDBValue(trim($this->f("DueDate")));
        $this->CurrencyID->SetDBValue(trim($this->f("CurrencyID")));
    }
//End SetValues Method

//Insert Method @142-5699FD44
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->InsertFields["InvoiceDate"]["Value"] = $this->ProformaDate->GetDBValue(true);
        ...
        $this->InsertFields["GayaOrderRef"]["Value"] = $this->GayaOrderRef->GetDBValue(true);
        ...
        $this->InsertFields["DueDate"]["Value"] = $this->PreviewDPDate->GetDBValue(true);
        $this->InsertFields["CurrencyID"]["Value"] = $this->CurrencyID->GetDBValue(true);
...
//Update Method @142-320AEB2B
    function Update()
    {
        ...
        $this->UpdateFields["InvoiceDate"]["Value"] = $this->ProformaDate->GetDBValue(true);
        ...
        $this->UpdateFields["InvoiceContactID"]["Value"] = $this->Attn->GetDBValue(true);
        ...
        $this->UpdateFields["DueDate"]["Value"] = $this->PreviewDPDate->GetDBValue(true);
        $this->UpdateFields["CurrencyID"]["Value"] = $this->CurrencyID->GetDBValue(true);
...
//Delete Method @142-1D467C32
    function Delete()
    {
        ...
        $this->SQL = "DELETE FROM tbladminist_invoice_h";
        $this->SQL = CCBuildSQL($this->SQL, $this->Where, "");
        if (!strlen($this->Where) && $this->Errors->Count() == 0) 
            $this->Errors->addError($CCSLocales->GetText("CCS_CustomOperationError_MissingParameters"));
...
} //End AddNewHeaderDataSource Class @142-FCB6E20C
...
//Class_Initialize Event @51-6EFDF0FC
    function clsEditableGridAddNewDetail($RelativePath, & $Parent)
    {
        ...
        $this->SumPrice = new clsControl(ccsTextBox, "SumPrice", "Total", ccsFloat, array(False, 2, Null, Null, False, "", "", 1, True, ""), NULL, $this);
        ...
        $this->Total_price = new clsControl(ccsHidden, "Total_price", "Total_price", ccsFloat, "", NULL, $this);
        $this->Total = new clsButton("Total", $Method, $this);
        $this->DiscountItem = new clsControl(ccsTextBox, "DiscountItem", "DiscountItem", ccsFloat, array(False, 2, Null, Null, False, "", "", 1, True, ""), NULL, $this);
    }
//End Class_Initialize Event
...
//GetFormParameters Method @51-2A37739C
    function GetFormParameters()
    {
        for($RowNumber = 1; $RowNumber <= $this->TotalRows; $RowNumber++)
        {
            ...
            $this->FormParameters["DiscountItem"][$RowNumber] = CCGetFromPost("DiscountItem_" . $RowNumber, NULL);
        }
    }
//End GetFormParameters Method

//Validate Method @51-817BCE12
    function Validate()
    {
        $Validation = true;
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "OnValidate", $this);
        ...
        for($this->RowNumber = 1; $this->RowNumber <= $this->TotalRows; $this->RowNumber++)
        {
            ...
            $this->DiscountItem->SetText($this->FormParameters["DiscountItem"][$this->RowNumber], $this->RowNumber);
...
//ValidateRow Method @51-96D48B02
    function ValidateRow()
    {
        ...
        $this->DiscountItem->Errors->Clear();
...
//CheckInsert Method @51-43924A69
    function CheckInsert()
    {
        ...
        $filed = ($filed || (is_array($this->FormParameters["DiscountItem"][$this->RowNumber]) && count($this->FormParameters["DiscountItem"][$this->RowNumber])) || strlen($this->FormParameters["DiscountItem"][$this->RowNumber]));
        return $filed;
    }
...
//InsertRow Method @51-F6FACB89
    function InsertRow()
    {
        ...
        $this->DataSource->DiscountItem->SetValue($this->DiscountItem->GetValue(true));
        $this->DataSource->Insert();
        $errors = "";
...
//FormScript Method @51-72FED353
    function FormScript($TotalRows)
    {
        ...
        $script .= "var " . $this->ComponentName . "DiscountItemID = 15;\n";
        $script .= "\nfunction initAddNewDetailElements() {\n";
        $script .= "\tvar ED = document.forms[\"AddNewDetail\"];\n";
        $script .= "\tAddNewDetailElements = new Array (\n";
        for($i = 1; $i <= $TotalRows; $i++) {
            $script .= "\t\tnew Array(" . "ED.Invoice_H_ID_" . $i . ", " . "ED.CollectID_" . $i . ", " . "ED.Qty_" . $i . ", " . "ED.Unit_" . $i . ", " . "ED.UnitPrice_" . $i . ", " . "ED.SumPrice_" . $i . ", " . "ED.CheckBox_Delete_" . $i . ", " . "ED.CollectCode_" . $i . ", " . "ED.Design_" . $i . ", " . "ED.NameDesc_" . $i . ", " . "ED.Category_" . $i . ", " . "ED.Size_" . $i . ", " . "ED.Texture_" . $i . ", " . "ED.Color_" . $i . ", " . "ED.Material_" . $i . ", " . "ED.DiscountItem_" . $i . ")";
        ...
        if ($is_next_record || ($EmptyRowsLeft && $this->InsertAllowed)) {
            do {
                ...
                if (!($this->FormSubmitted) && $is_next_record) {
                    ...
                    $this->SumPrice->SetValue($this->DataSource->SumPrice->GetValue());
                ...
                $this->DiscountItem->Show($this->RowNumber);
...
//DataSource Variables @51-01DA1E06
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @51-0BD6131A
    function clsAddNewDetailDataSource(& $Parent)
    {
        ...
        $this->InsertFields["Total"] = array("Name" => "Total", "Value" => "", "DataType" => ccsFloat, "OmitIfEmpty" => 1);
        $this->InsertFields["CollectCode"] = array("Name" => "CollectCode", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["DiscountItem"] = array("Name" => "DiscountItem", "Value" => "", "DataType" => ccsFloat, "OmitIfEmpty" => 1);
        $this->UpdateFields["Invoice_H_ID"] = array("Name" => "Invoice_H_ID", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
        ...
        $this->UpdateFields["Total"] = array("Name" => "Total", "Value" => "", "DataType" => ccsFloat, "OmitIfEmpty" => 1);
        $this->UpdateFields["CollectCode"] = array("Name" => "CollectCode", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->UpdateFields["DiscountItem"] = array("Name" => "DiscountItem", "Value" => "", "DataType" => ccsFloat, "OmitIfEmpty" => 1);
    }
//End DataSourceClass_Initialize Event
...
//Insert Method @51-38BD8632
    function Insert()
    {
        ...
        $this->InsertFields["Total"]["Value"] = $this->SumPrice->GetDBValue(true);
        $this->InsertFields["CollectCode"]["Value"] = $this->CollectCode->GetDBValue(true);
        $this->InsertFields["DiscountItem"]["Value"] = $this->DiscountItem->GetDBValue(true);
...
//Update Method @51-75225D7D
    function Update()
    {
        ...
        $this->UpdateFields["Total"]["Value"] = $this->SumPrice->GetDBValue(true);
        $this->UpdateFields["CollectCode"]["Value"] = $this->CollectCode->GetDBValue(true);
        $this->UpdateFields["DiscountItem"]["Value"] = $this->DiscountItem->GetDBValue(true);
