<?php
//Include Common Files @1-DE998C34
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "ProformaChoose.php");
...
//Operation Method @21-B9776B50
    function Operation()
    {
        ...
        $Redirect = "ProformaChoose.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "ProformaChoose.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @2-2C3FE4A6
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->Proforma_H_ID->Parameters = CCAddParam($this->Proforma_H_ID->Parameters, "ContactID", $this->DataSource->f("ContactID"));
                $this->Proforma_H_ID->Parameters = CCAddParam($this->Proforma_H_ID->Parameters, "AddressID", $this->DataSource->f("AddressID"));
                $this->Proforma_H_ID->Parameters = CCAddParam($this->Proforma_H_ID->Parameters, "ClientID", $this->DataSource->f("ClientID"));
...
//DataSource Variables @2-BF98AEED
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-62BC6195
...
//SetValues Method @2-6ADE92FA
    function SetValues()
    {
        ...
        $this->ContactID->SetDBValue(trim($this->f("ProformaContactID")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ProformaChoose.html";
$BlockToParse = "main";
...
//Include events file @1-9A49EB5B
include_once("./ProformaChoose_events.php");
