...
//Class_Initialize Event @2-56DFF692
...
"FROM tbladminist_addressbook_contact {SQL_Where} {SQL_OrderBy}";
            ...
            $this->LinkChangeDeliveryContact->Page = "AddQuotation.php";
...
"FROM tbladminist_currency {SQL_Where} {SQL_OrderBy}";
            ...
            $this->DeliveryAddressID = new clsControl(ccsListBox, "DeliveryAddressID", "DeliveryAddressID", ccsText, "", CCGetRequestParam("DeliveryAddressID", $Method, NULL), $this);
...
//Show Method @2-1CCC81A0
    function Show()
    {
        ...
        $this->LinkChange->Parameters = CCGetQueryString("QueryString", array("QuotationContactID", "AddressID", "ccsForm"));
...
//DataSource Variables @2-706E31C9
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-7D978B8E
    function clsAddNewHeaderDataSource(& $Parent)
    {
        ...
        $this->DeliveryAddressID = new clsField("DeliveryAddressID", ccsText, "");
        ...
        $this->InsertFields["DeliveryAddressID"] = array("Name" => "DeliveryAddressID", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
...
//SetValues Method @2-9C028A84
    function SetValues()
    {
        ...
        $this->DeliveryAddressID->SetDBValue($this->f("DeliveryAddressID"));
    }
//End SetValues Method

//Insert Method @2-691E6F18
    function Insert()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//Update Method @2-98FBF9D7
    function Update()
    {
        ...
        $this->cp["DeliveryAddressID"] = new clsSQLParameter("ctrlDeliveryAddressID", ccsInteger, "", "", $this->DeliveryAddressID->GetValue(true), NULL, false, $this->ErrorBlock);
        ...
        if (!is_null($this->cp["DeliveryAddressID"]->GetValue()) and !strlen($this->cp["DeliveryAddressID"]->GetText()) and !is_bool($this->cp["DeliveryAddressID"]->GetValue())) 
            $this->cp["DeliveryAddressID"]->SetValue($this->DeliveryAddressID->GetValue(true));
        ...
        $this->UpdateFields["DeliveryAddressID"]["Value"] = $this->cp["DeliveryAddressID"]->GetDBValue(true);
