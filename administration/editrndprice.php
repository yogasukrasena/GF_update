<?php
//Include Common Files @1-80FC7DB8
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "EditRnDPrice.php");
    ...
    function Operation()
    {
        ...
        if($this->Validate()) {
            if($this->PressedButton == "Button_Update") {
                $Redirect = "RnDPriceList.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
//DataSourceClass_Initialize Event @2-0054485E
    function clstblcollect_masterDataSource(& $Parent)
    {
        ...
        $this->UpdateFields["sID"] = array("Name" => "sID", "Value" => "", "DataType" => ccsInteger, "OmitIfEmpty" => 1);
    }
//End DataSourceClass_Initialize Event

//Prepare Method @2-DCD088EA
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
...
//Open Method @2-61D55FC1
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT sID, RealSellingPrice AS RealSellingPrice, PriceDollar AS PriceDollar, PriceEuro AS PriceEuro \n\n" .
...
//SetValues Method @2-15C1A9EA
    function SetValues()
    {
        ...
        $this->ID->SetDBValue(trim($this->f("sID")));
    }
//End SetValues Method

//Update Method @2-1D9E37DF
    function Update()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->UpdateFields["sID"]["Value"] = $this->ID->GetDBValue(true);
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "EditRnDPrice.html";
$BlockToParse = "main";
...
//Include events file @1-561B612C
include_once("./EditRnDPrice_events.php");
