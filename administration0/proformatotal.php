<?php
//Include Common Files @1-2D83BCC2
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "ProformaTotal.php");
...
//Open Method @2-11A4346A
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT GrandTotal, Fumigation, Packaging, Discount, SubTotal, Proforma_H_ID, PackagingCost \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ProformaTotal.html";
$BlockToParse = "main";
...
//Include events file @1-DE83A2D8
include_once("./ProformaTotal_events.php");
