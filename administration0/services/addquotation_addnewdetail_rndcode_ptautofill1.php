<?php
//Include Common Files @1-C30E2CE1
define("RelativePath", "..");
define("PathToCurrentPage", "/services/");
define("FileName", "AddQuotation_AddNewDetail_RndCode_PTAutoFill1.php");
...
//Class_Initialize Event @2-20EAD788
...
//DataSourceClass_Initialize Event @2-EC4A9DD8
...
//Open Method @2-F2709017
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM sampleceramic";
        $this->SQL = "SELECT sID, SampleCode, SampleDescription, ClientCode, ClientDescription, Photo1, Width, Height, Diameter, Length, RealSellingPrice \n\n" .
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "AddQuotation_AddNewDetail_RndCode_PTAutoFill1.html";
$BlockToParse = "main";
