<?php
//Include Common Files @1-920E244A
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "ReportPro.php");
...
//Grid ReportGroup class @2-519780E3
class clsReportGroupGrid {
    ...
    public $ar_proforma_Rate, $_ar_proforma_RateAttributes;
    ...
    function SetControls($PrevGroup = "") {
        ...
        $this->ar_proforma_Rate = $this->Parent->ar_proforma_Rate->Value;
    ...
    function SetTotalControls($mode = "", $PrevGroup = "") {
        ...
        $this->_ar_proforma_RateAttributes = $this->Parent->ar_proforma_Rate->Attributes->GetAsArray();
    ...
    function SyncWithHeader(& $Header) {
        ...
        $this->ar_proforma_Rate = $Header->ar_proforma_Rate;
        $Header->_ar_proforma_RateAttributes = $this->_ar_proforma_RateAttributes;
        $this->Parent->ar_proforma_Rate->Value = $Header->ar_proforma_Rate;
        $this->Parent->ar_proforma_Rate->Attributes->RestoreFromArray($Header->_ar_proforma_RateAttributes);
...
//Grid GroupsCollection class @2-70E9E04A
class clsGroupsCollectionGrid {
    ...
    function RestoreValues() {
        ...
        $this->Parent->ar_proforma_Rate->Value = $this->Parent->ar_proforma_Rate->initialValue;
...
//Class_Initialize Event @2-3C73510D
    function clsReportGrid($RelativePath = "", & $Parent)
    {
        ...
        $this->ar_proforma_Rate = new clsControl(ccsReportLabel, "ar_proforma_Rate", "ar_proforma_Rate", ccsFloat, array(False, 2, Null, Null, False, "", "", 1, True, ""), "", $this);
...
//CheckErrors Method @2-9B10127D
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->ar_proforma_Rate->Errors->Count());
...
//GetErrors Method @2-701DD6BF
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->ar_proforma_Rate->Errors->ToString());
...
//Show Method @2-244A6042
    function Show()
    {
        ...
        while($is_next_record) {
            ...
            $this->ar_proforma_Rate->SetValue($this->DataSource->ar_proforma_Rate->GetValue());
        ...
        if($this->CheckErrors()) {
            ...
            $this->ControlsVisible["ar_proforma_Rate"] = $this->ar_proforma_Rate->Visible;
            ...
            do {
                ...
                switch ($items[$i]->GroupType) {
                    Case "":
                        ...
                        $this->ar_proforma_Rate->SetValue($items[$i]->ar_proforma_Rate);
                        $this->ar_proforma_Rate->Attributes->RestoreFromArray($items[$i]->_ar_proforma_RateAttributes);
...
//DataSource Variables @2-6D02ACD4
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-1F4DFC31
    function clsGridDataSource(& $Parent)
    {
        ...
        $this->ar_proforma_Rate = new clsField("ar_proforma_Rate", ccsFloat, "");
...
//SetOrder Method @2-3EB4B1D0
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "";
        $this->Order = CCGetOrder($this->Order, $SorterName, $SorterDirection, 
            array("Sorter_due_date" => array("PreviewDPDate", ""), 
            "Sorter_paid_date" => array("paid_date", "")));
    }
//End SetOrder Method

//Prepare Method @2-4F4EB99A
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->wp->AddParameter("2", "urls_due_date", ccsDate, $DefaultDateFormat, $this->DateFormat, $this->Parameters["urls_due_date"], "", false);
        $this->wp->AddParameter("3", "urls_due_date1", ccsDate, $DefaultDateFormat, $this->DateFormat, $this->Parameters["urls_due_date1"], "", false);
        $this->wp->AddParameter("4", "urls_rec_date", ccsDate, $DefaultDateFormat, $this->DateFormat, $this->Parameters["urls_rec_date"], "", false);
        $this->wp->AddParameter("5", "urls_rec_date1", ccsDate, $DefaultDateFormat, $this->DateFormat, $this->Parameters["urls_rec_date1"], "", false);
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "ar_proforma.client_id", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsInteger),false);
        $this->wp->Criterion[2] = $this->wp->Operation(opGreaterThanOrEqual, "tbladminist_proforma_h.PreviewDPDate", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsDate),false);
        $this->wp->Criterion[3] = $this->wp->Operation(opLessThanOrEqual, "tbladminist_proforma_h.PreviewDPDate", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsDate),false);
        $this->wp->Criterion[4] = $this->wp->Operation(opGreaterThanOrEqual, "pay_proforma.paid_date", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsDate),false);
        $this->wp->Criterion[5] = $this->wp->Operation(opLessThanOrEqual, "pay_proforma.paid_date", $this->wp->GetDBValue("5"), $this->ToSQL($this->wp->GetDBValue("5"), ccsDate),false);
...
//Open Method @2-795A9D4D
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT ClientCompany, ar_proforma.*, paid_date, amount_paid, pay_proforma.Rate AS pay_proforma_Rate, (ar_proforma.GrandTotal*ar_proforma.Rate) AS GrandTotalRupiah,\n\n" .
        "(pay_proforma.amount_paid*pay_proforma.Rate) AS ReceivedRupiah, PreviewDPDate \n\n" .
        "FROM ((ar_proforma LEFT JOIN pay_proforma ON\n\n" .
        "pay_proforma.ar_proforma_id = ar_proforma.ar_proforma_id) LEFT JOIN tbladminist_client ON\n\n" .
        "ar_proforma.client_id = tbladminist_client.ClientID) INNER JOIN tbladminist_proforma_h ON\n\n" .
        "ar_proforma.proforma_h_id = tbladminist_proforma_h.Proforma_H_ID {SQL_Where} {SQL_OrderBy}";
...
//Operation Method @41-D89B4C06
    function Operation()
    {
        ...
        $Redirect = "ReportPro.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "ReportPro.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ReportPro.html";
$BlockToParse = "main";
...
//Include events file @1-E4BA288E
include_once("./ReportPro_events.php");
...
$Report_Print->Page = "ReportPro.php";
$MainPage->Grid = & $Grid;
