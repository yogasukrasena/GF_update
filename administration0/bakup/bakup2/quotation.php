<?php
//Include Common Files @1-CE35067B
define("RelativePath", "../..");
define("PathToCurrentPage", "/bakup/bakup2/");
...
//Class_Initialize Event @35-A36E5042
...
"FROM sampleceramic {SQL_Where} {SQL_OrderBy}";
        ...
        $this->Quotation_H_ID = new clsControl(ccsTextBox, "Quotation_H_ID", "ID Quotation H", ccsInteger, "", NULL, $this);
...
//Initialize HTML Template @1-2A564C6E
...
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", strrev(">retnec/<>tnof/<>llams/<.o;501#&du;611#&;38#&>-- CCS --!< ;101#&;301#&;411#&;79#&;401#&C;101#&;001#&;111#&;76#&>-- CCS --!< htiw>-- CCS --!< de;611#&;79#&;411#&eneG>llams<>\"lairA\"=ecaf tnof<>retnec<") . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", strrev(">retnec/<>tnof/<>llams/<.o;501#&du;611#&;38#&>-- CCS --!< ;101#&;301#&;411#&;79#&;401#&C;101#&;001#&;111#&;76#&>-- CCS --!< htiw>-- CCS --!< de;611#&;79#&;411#&eneG>llams<>\"lairA\"=ecaf tnof<>retnec<") . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= strrev(">retnec/<>tnof/<>llams/<.o;501#&du;611#&;38#&>-- CCS --!< ;101#&;301#&;411#&;79#&;401#&C;101#&;001#&;111#&;76#&>-- CCS --!< htiw>-- CCS --!< de;611#&;79#&;411#&eneG>llams<>\"lairA\"=ecaf tnof<>retnec<");
}
