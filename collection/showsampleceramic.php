...
//Class_Initialize Event @2-47275FB6
    function clsRecordAddSampleCeramic($RelativePath, & $Parent)
    {
        ...
        if($this->Visible)
        {
            ...
            $this->ClayKG = new clsControl(ccsLabel, "ClayKG", "Clay KG", ccsFloat, array(False, 2, Null, "", False, "", "", 1, True, ""), CCGetRequestParam("ClayKG", $Method, NULL), $this);
            ...
            $this->DesignDesc = new clsControl(ccsLabel, "DesignDesc", "DesignDesc", ccsText, "", CCGetRequestParam("DesignDesc", $Method, NULL), $this);
            ...
            $this->CategoryDesc = new clsControl(ccsLabel, "CategoryDesc", "CategoryDesc", ccsText, "", CCGetRequestParam("CategoryDesc", $Method, NULL), $this);
            $this->SizeCode = new clsControl(ccsHidden, "SizeCode", "SizeCode", ccsText, "", CCGetRequestParam("SizeCode", $Method, NULL), $this);
            $this->SizeDesc = new clsControl(ccsLabel, "SizeDesc", "SizeDesc", ccsText, "", CCGetRequestParam("SizeDesc", $Method, NULL), $this);
            $this->TextureCode = new clsControl(ccsHidden, "TextureCode", "TextureCode", ccsText, "", CCGetRequestParam("TextureCode", $Method, NULL), $this);
            $this->TextureDesc = new clsControl(ccsLabel, "TextureDesc", "TextureDesc", ccsText, "", CCGetRequestParam("TextureDesc", $Method, NULL), $this);
            $this->ColorCode = new clsControl(ccsHidden, "ColorCode", "ColorCode", ccsText, "", CCGetRequestParam("ColorCode", $Method, NULL), $this);
            $this->ColorDesc = new clsControl(ccsLabel, "ColorDesc", "ColorDesc", ccsText, "", CCGetRequestParam("ColorDesc", $Method, NULL), $this);
            ...
            $this->MaterialDesc = new clsControl(ccsLabel, "MaterialDesc", "MaterialDesc", ccsText, "", CCGetRequestParam("MaterialDesc", $Method, NULL), $this);
            $this->lblClay = new clsControl(ccsLabel, "lblClay", "lblClay", ccsText, "", CCGetRequestParam("lblClay", $Method, NULL), $this);
            ...
            $this->GlazeTechnique = new clsControl(ccsLabel, "GlazeTechnique", "GlazeTechnique", ccsText, "", CCGetRequestParam("GlazeTechnique", $Method, NULL), $this);
        }
    }
...
//CheckErrors Method @2-1534904F
    function CheckErrors()
    {
        ...
        $errors = ($errors || $this->DesignDesc->Errors->Count());
        ...
        $errors = ($errors || $this->CategoryDesc->Errors->Count());
        $errors = ($errors || $this->SizeCode->Errors->Count());
        $errors = ($errors || $this->SizeDesc->Errors->Count());
        $errors = ($errors || $this->TextureCode->Errors->Count());
        $errors = ($errors || $this->TextureDesc->Errors->Count());
        $errors = ($errors || $this->ColorCode->Errors->Count());
        $errors = ($errors || $this->ColorDesc->Errors->Count());
        $errors = ($errors || $this->MaterialCode->Errors->Count());
        $errors = ($errors || $this->MaterialDesc->Errors->Count());
        $errors = ($errors || $this->lblClay->Errors->Count());
...
//Show Method @2-E3FB6394
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            ...
            $Error = ComposeStrings($Error, $this->DesignDesc->Errors->ToString());
            ...
            $Error = ComposeStrings($Error, $this->CategoryDesc->Errors->ToString());
            $Error = ComposeStrings($Error, $this->SizeCode->Errors->ToString());
            $Error = ComposeStrings($Error, $this->SizeDesc->Errors->ToString());
            $Error = ComposeStrings($Error, $this->TextureCode->Errors->ToString());
            $Error = ComposeStrings($Error, $this->TextureDesc->Errors->ToString());
            $Error = ComposeStrings($Error, $this->ColorCode->Errors->ToString());
            $Error = ComposeStrings($Error, $this->ColorDesc->Errors->ToString());
            $Error = ComposeStrings($Error, $this->MaterialCode->Errors->ToString());
            $Error = ComposeStrings($Error, $this->MaterialDesc->Errors->ToString());
            $Error = ComposeStrings($Error, $this->lblClay->Errors->ToString());
        ...
        $this->DesignDesc->Show();
        $this->NameCode->Show();
        $this->NameDesc->Show();
        $this->CategoryCode->Show();
        $this->CategoryDesc->Show();
        $this->SizeCode->Show();
        $this->SizeDesc->Show();
        $this->TextureCode->Show();
        $this->TextureDesc->Show();
        $this->ColorCode->Show();
        $this->ColorDesc->Show();
        $this->MaterialCode->Show();
        $this->MaterialDesc->Show();
        $this->lblClay->Show();
        $this->Diameter->Show();
...
//DataSource Variables @2-B83F8F23
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @2-48E9438A
    function clsAddSampleCeramicDataSource(& $Parent)
    {
        ...
        $this->DesignDesc = new clsField("DesignDesc", ccsText, "");
        ...
        $this->CategoryDesc = new clsField("CategoryDesc", ccsText, "");
        
        $this->SizeCode = new clsField("SizeCode", ccsText, "");
        
        $this->SizeDesc = new clsField("SizeDesc", ccsText, "");
        
        $this->TextureCode = new clsField("TextureCode", ccsText, "");
        
        $this->TextureDesc = new clsField("TextureDesc", ccsText, "");
        
        $this->ColorCode = new clsField("ColorCode", ccsText, "");
        
        $this->ColorDesc = new clsField("ColorDesc", ccsText, "");
        
        $this->MaterialCode = new clsField("MaterialCode", ccsText, "");
        
        $this->MaterialDesc = new clsField("MaterialDesc", ccsText, "");
        
        $this->lblClay = new clsField("lblClay", ccsText, "");
...
//Open Method @2-420EC081
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->SQL = "SELECT DesignMatNote, DesignMatQty4, DesignMatQty3, DesignMatQty2, DesignMatQty1, DesignMat4, DesignMat3, DesignMat2, DesignMat1,\n\n" .
        "FinalSizeNote, SampCeramicVolume, Diameter, Length, Height, Width, FiringNote, Firing, GlazeTemp, GlazeNote, GlazeDensity4,\n\n" .
        "GlazeDensity3, GlazeDensity2, GlazeDensity1, Glaze4, Glaze3, Glaze2, Glaze1, StainOxide4, StainOxideNote, StainOxide3, StainOxide2,\n\n" .
        "StainOxide1, BisqueTemp, EngobeNote, Engobe4, Engobe3, Engobe2, Engobe1, ToolsNote, Tools4, Tools3, Tools2, Tools1, TextureNote,\n\n" .
        "Texture4, Texture3, Texture2, Texture1, EstruderNote, Estruder4, Estruder3, Estruder2, Estruder1, CastingNote, Casting4,\n\n" .
        "Casting3, Casting2, Casting1, Feet, Rim, BuildTechNote, BuildTech, ClayNote, ClayKG, Clay, Photo4,\n\n" .
        "Photo3, Photo2, Photo1, TechDraw, CollectDate, ClientDescription, ClientCode, MaterialCode, ColorCode, TextureCode, SizeCode,\n\n" .
        "CategoryCode, NameCode, DesignCode, CollectCode, ID \n\n" .
