...
//Include Common Files @1-B4195844
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "CollectName.php");
...
//Operation Method @3-F2CA86F6
    function Operation()
    {
        ...
        $Redirect = "CollectName.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "CollectName.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Class_Initialize Event @2-AB457BC4
    function clsGridtblcollect_name($RelativePath, & $Parent)
    {
        ...
        $this->NameCode->Page = "CollectName.php";
        ...
        $this->tblcollect_name_Insert->Parameters = CCGetQueryString("QueryString", array("NameCode", "isParamsEncoded", "FormFilter", "ccsForm"));
        $this->tblcollect_name_Insert->Page = "CollectName.php";
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->NameCode->Parameters = CCAddParam($this->NameCode->Parameters, "NameCode", $this->DataSource->f("NameCode"));
...
//Initialize Method @19-3EC2DC74
    function Initialize()
    {
        ...
        $this->DataSource->Parameters["urlNameCode"] = CCGetFromGet("NameCode", NULL);
    }
//End Initialize Method
...
//Prepare Method @19-B451C3D0
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->wp = new clsSQLParameters($this->ErrorBlock);
        $this->wp->AddParameter("1", "urlNameCode", ccsText, "", "", $this->Parameters["urlNameCode"], "", false);
        $this->AllParametersSet = $this->wp->AllParamsSet();
        $this->wp->Criterion[1] = $this->wp->Operation(opEqual, "NameCode", $this->wp->GetDBValue("1"), $this->ToSQL($this->wp->GetDBValue("1"), ccsText),false);
        $this->Where = 
             $this->wp->Criterion[1];
    }
//End Prepare Method
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "CollectName.html";
$BlockToParse = "main";
...
//Include events file @1-731EEDA3
include_once("./CollectName_events.php");
