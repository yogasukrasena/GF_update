...
//Include Common Files @1-028012AF
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "SupplierPopup.php");
...
class clsGridSupplierGrid { //SupplierGrid class @2-45285F3B

//Variables @2-6DFCE2D6
...
//Class_Initialize Event @2-E6E69241
    function clsGridSupplierGrid($RelativePath, & $Parent)
    {
        global $FileName;
        global $CCSLocales;
        global $DefaultDateFormat;
        $this->ComponentName = "SupplierGrid";
        $this->Visible = True;
        $this->Parent = & $Parent;
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Grid SupplierGrid";
        $this->Attributes = new clsAttributes($this->ComponentName . ":");
        $this->DataSource = new clsSupplierGridDataSource($this);
        ...
        $this->SorterName = CCGetParam("SupplierGridOrder", "");
        $this->SorterDirection = CCGetParam("SupplierGridDir", "");
        ...
        $this->SupID = new clsControl(ccsHidden, "SupID", "SupID", ccsText, "", CCGetRequestParam("SupID", ccsGet, NULL), $this);
...
//Show Method @2-04031063
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            $this->ControlsVisible["SupID"] = $this->SupID->Visible;
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->SupID->SetValue($this->DataSource->SupID->GetValue());
...
//GetErrors Method @2-D564A467
    function GetErrors()
    {
        ...
        $errors = ComposeStrings($errors, $this->SupID->Errors->ToString());
...
//DataSourceClass_Initialize Event @2-E6321A7D
    function clsSupplierGridDataSource(& $Parent)
    {
        $this->Parent = & $Parent;
        $this->ErrorBlock = "Grid SupplierGrid";
        $this->Initialize();
        ...
        $this->SupID = new clsField("SupID", ccsText, "");
...
//SetValues Method @2-84C5B3B2
    function SetValues()
    {
        ...
        $this->SupID->SetDBValue($this->f("ID"));
        $this->SupCode->SetDBValue($this->f("SupCode"));
    }
//End SetValues Method

} //End SupplierGridDataSource Class @2-FCB6E20C
...
//Operation Method @3-3ADDECB3
    function Operation()
    {
        ...
        $Redirect = "SupplierPopup.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "SupplierPopup.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_SupCode", "s_SupCompany", "s_SupItems", "ccsForm")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "SupplierPopup.html";
$BlockToParse = "main";
...
//Include events file @1-5C9BE81B
include_once("./SupplierPopup_events.php");
...
// Controls
$SupplierGrid = new clsGridSupplierGrid("", $MainPage);
$tblsupplierSearch = new clsRecordtblsupplierSearch("", $MainPage);
$MainPage->SupplierGrid = & $SupplierGrid;
...
//Execute Components @1-22D66596
$tblsupplierSearch->Operation();
//End Execute Components

//Go to destination page @1-BB88B991
if($Redirect)
{
...
//Show Page @1-2C861439
$SupplierGrid->Show();
$tblsupplierSearch->Show();
$Tpl->block_path = "";
