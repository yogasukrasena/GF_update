...
//Include Common Files @1-7E243355
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "DesignMatPopup.php");
...
//Operation Method @2-DB7F0EDD
    function Operation()
    {
        ...
        $Redirect = "DesignMatPopup.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "DesignMatPopup.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")), CCGetQueryString("QueryString", array("s_DesignMatCode", "s_DesignMatDescription", "s_SupCompany", "ccsForm")));
...
//Class_Initialize Event @7-B84A1271
    function clsGridtbldesignmatGrid($RelativePath, & $Parent)
    {
        ...
        $this->DesignMatCode->Page = "DesignMatPopup.php";
...
//DataSource Variables @7-AC83930E
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @7-EEB67C68
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "DesignMatPopup.html";
$BlockToParse = "main";
...
//Include events file @1-B56F8903
include_once("./DesignMatPopup_events.php");
