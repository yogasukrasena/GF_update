<?php
//Include Common Files @1-BBBD1C93
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "ShowSampleOther.php");
...
//Class_Initialize Event @2-F2DB3717
    ...
    function Show()
    {
        ...
        if($this->EditMode) {
            ...
            if($this->DataSource->Errors->Count() == 0 && $this->DataSource->next_record()) {
                ...
                $this->TotalDesMat1->SetValue($this->DataSource->TotalDesMat1->GetValue());
                $this->TotalDesMat2->SetValue($this->DataSource->TotalDesMat2->GetValue());
                $this->TotalDesMat3->SetValue($this->DataSource->TotalDesMat3->GetValue());
                $this->TotalDesMat4->SetValue($this->DataSource->TotalDesMat4->GetValue());
                $this->TotalDesMat5->SetValue($this->DataSource->TotalDesMat5->GetValue());
                ...
                $this->TotalDesMat->SetValue($this->DataSource->TotalDesMat->GetValue());
                $this->TotalCostPrice->SetValue($this->DataSource->TotalCostPrice->GetValue());
                $this->TotalCost->SetValue($this->DataSource->TotalCost->GetValue());
...
//DataSourceClass_Initialize Event @2-ABF1683F
...
//SetValues Method @2-902DAA59
    function SetValues()
    {
        ...
        $this->TotalDesMat1->SetDBValue(trim($this->f("TotalDesMat1")));
        $this->TotalDesMat2->SetDBValue(trim($this->f("TotalDesMat2")));
        $this->TotalDesMat3->SetDBValue(trim($this->f("TotalDesMat3")));
        $this->TotalDesMat4->SetDBValue(trim($this->f("TotalDesMat4")));
        $this->TotalDesMat5->SetDBValue(trim($this->f("TotalDesMat5")));
        ...
        $this->TotalDesMat->SetDBValue(trim($this->f("TotalDesMat")));
        $this->TotalCostPrice->SetDBValue(trim($this->f("TotalCostPrice")));
        $this->TotalCost->SetDBValue(trim($this->f("TotalCost")));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "ShowSampleOther.html";
$BlockToParse = "main";
...
//Include events file @1-E1A00ED1
include_once("./ShowSampleOther_events.php");
