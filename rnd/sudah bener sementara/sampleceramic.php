...
//Class_Initialize Event @2-0E10FDE5
    function clsGridsampleceramicGrid($RelativePath, & $Parent)
    {
        ...
        $this->SampleCode->Page = "SampleCeramic.php";
    ...
    function Show()
    {
        ...
        if (!$this->IsEmpty) {
            ...
            while ($this->ForceIteration || (($this->RowNumber < $this->PageSize) &&  ($this->HasRecord = $this->DataSource->has_next_record()))) {
                ...
                $this->edit->Parameters = CCAddParam($this->edit->Parameters, "sID", $this->DataSource->f("sID"));
...
//Open Method @2-DC40060A
    function Open()
    {
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeBuildSelect", $this->Parent);
        $this->CountSQL = "SELECT COUNT(*)\n\n" .
        "FROM sampleceramic";
        $this->SQL = "SELECT sID, SampleCode, SampleDescription, Photo1 \n\n" .
        "FROM sampleceramic {SQL_Where} {SQL_OrderBy}";
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "BeforeExecuteSelect", $this->Parent);
        if ($this->CountSQL) 
...
class clsRecordsampleceramic1 { //sampleceramic1 Class @22-FA92DB06
...
//Class_Initialize Event @22-17B64DB5
    function clsRecordsampleceramic1($RelativePath, & $Parent)
    {
        ...
        $this->RelativePath = $RelativePath;
        $this->Errors = new clsErrors();
        $this->ErrorBlock = "Record sampleceramic1/Error";
...
//CheckErrors Method @22-043C54E0
    function CheckErrors()
    {
        $errors = false;
...
} //End sampleceramic1 Class @22-FCB6E20C

class clssampleceramic1DataSource extends clsDBgayafusionall {  //sampleceramic1DataSource Class @22-DE1C5743

//DataSource Variables @22-BBC2F868
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @22-3FC9CD0C
...
} //End sampleceramic1DataSource Class @22-FCB6E20C
...
$sampleceramic1 = new clsRecordsampleceramic1("", $MainPage);
...
$Panel1->AddComponent("sampleceramic1", $sampleceramic1);
...
//Execute Components @1-9A53936D
$sampleceramicSearch->Operation();
$sampleceramic1->Operation();
//End Execute Components

//Go to destination page @1-80D0EE69
if($Redirect)
{
...
//Show Page @1-6A9D4641
$Panel1->Show();
$Tpl->block_path = "";
$Tpl->Parse($BlockToParse, false);
if (!isset($main_block)) $main_block = $Tpl->GetVar($BlockToParse);
if(preg_match("/<\/body>/i", $main_block)) {
    $main_block = preg_replace("/<\/body>/i", "<center><font face=\"Aria" . "l\"><small>&#71;e&#110;&#101;&" . "#114;&#97;t&#101;&#100; <!-- " . "SCC -->&#119;i&#116;h <!-- C" . "CS -->Co&#100;&#101;&#67" . ";&#104;ar&#103;e <!-- CCS" . " -->S&#116;&#117;dio.</small" . "></font></center>" . "</body>", $main_block);
} else if(preg_match("/<\/html>/i", $main_block) && !preg_match("/<\/frameset>/i", $main_block)) {
    $main_block = preg_replace("/<\/html>/i", "<center><font face=\"Aria" . "l\"><small>&#71;e&#110;&#101;&" . "#114;&#97;t&#101;&#100; <!-- " . "SCC -->&#119;i&#116;h <!-- C" . "CS -->Co&#100;&#101;&#67" . ";&#104;ar&#103;e <!-- CCS" . " -->S&#116;&#117;dio.</small" . "></font></center>" . "</html>", $main_block);
} else if(!preg_match("/<\/frameset>/i", $main_block)) {
    $main_block .= "<center><font face=\"Aria" . "l\"><small>&#71;e&#110;&#101;&" . "#114;&#97;t&#101;&#100; <!-- " . "SCC -->&#119;i&#116;h <!-- C" . "CS -->Co&#100;&#101;&#67" . ";&#104;ar&#103;e <!-- CCS" . " -->S&#116;&#117;dio.</small" . "></font></center>";
}
$CCSEventResult = CCGetEvent($CCSEvents, "BeforeOutput", $MainPage);
if ($CCSEventResult) echo $main_block;
//End Show Page

//Unload Page @1-AB8A4500
$CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
$DBgayafusionall->close();
unset($sampleceramicSearch);
unset($sampleceramicGrid);
